...
public class RunData
{
	...
	public RunData(ESupplier<Connection , SQLException> aConnSupplier , String aTableName) throws SQLException
	{
	...
	public void put(String aKey , long aValue) throws SQLException
	{
		put(aKey , Long.toString(aValue)) ;
	}
	
	public void put(String aKey , String aValue) throws SQLException
	{
		if(aValue == null)
			aValue = "" ;
		String oldValue = mDataMap.put(aKey, aValue) ;
	...
	public void putAll(Map<String, String> aDataMap) throws SQLException
	{
		try(Connection conn = mConnSupplier.get())
		{
			UpdateOrInsertKit kit = createUpdateOrInsertKit(conn) ;
