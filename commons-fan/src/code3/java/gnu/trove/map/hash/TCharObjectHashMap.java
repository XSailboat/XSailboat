...
public class TCharObjectHashMap<V> extends TCharHash implements
   ...
   public char[] keys( char[] dest ) {
    ...
    class TCharObjectHashIterator<U> extends THashPrimitiveIterator
        implements TCharObjectIterator<U> {

        /** the collection being iterated over */
        private final TCharObjectHashMap<U> _map;
         ...
         */
        public TCharObjectHashIterator( TCharObjectHashMap<U> map ) {
            super( map );
            this._map = map;
        }
