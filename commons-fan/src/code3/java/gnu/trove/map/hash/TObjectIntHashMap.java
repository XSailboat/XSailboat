...
public class TObjectIntHashMap<K> extends TObjectHash<K>
    ...
    /**
     * 
     * @param aNoEntryValue			取不到指定键时返回的缺省值
     * @return
     */
    public static <K> TObjectIntHashMap<K> create(int aNoEntryValue)
    {
    	TObjectIntHashMap<K> map = new TObjectIntHashMap<>() ;
    	map.no_entry_value = aNoEntryValue ;
    	return map ;
    }
} // TObjectIntHashMap
