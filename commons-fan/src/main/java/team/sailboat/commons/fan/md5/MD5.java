package team.sailboat.commons.fan.md5;
...
public class MD5 {
    ...
    public static String calMd5(Object aObj)
    {
  	  if(aObj != null && aObj instanceof Serializable)
  	  {
  			MD5OutputStream mouts = new MD5OutputStream(new NullOutputStream()) ;
  			try(ObjectOutputStream oouts = new ObjectOutputStream(mouts))
			{
				oouts.writeObject(aObj) ;
				oouts.flush() ;
	...
	public static String calMd5(byte[] aBytes)
	{
