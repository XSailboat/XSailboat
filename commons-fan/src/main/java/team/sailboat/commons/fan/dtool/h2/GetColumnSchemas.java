...
class GetColumnSchemas implements EConsumer<ResultSet , SQLException>
{
	...
	static
	{
		...
		sOtherColNameMap.put("CHARACTER_SET" , H2Features.COLUMN__CHARSET) ;
		sOtherColNameMap.put("COLLATION" , H2Features.COLUMN__COLLATION) ;
		sOtherColNameMap.put("ON_UPDATE" , H2Features.COLUMN__ON_UPDATE) ;
	}
	...
	{
		H2ColumnSchema colSchema = new H2ColumnSchema() ;
