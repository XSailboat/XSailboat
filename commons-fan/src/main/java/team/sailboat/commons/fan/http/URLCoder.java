...
{
	public static final String sName = "DefaultURLCoder" ;
	
	static URLCoder sDefault ;
	static URLCoder sInstance_1 ;
	...
	protected URLCoder(boolean aBlankAsPlus)
	{
	...
	{
		return encode(aParam , URLENCODER , mBlankAsPlus) ;
	}
	...
	{
		return encode(aParam , URLENCODER , true) ;
	}
	
	public String encodeHeaderValue(String aParam)
	{
		return encode(aParam , HEADER_VAL  , true) ;
	}
	...
	public String splitEncodePath(String aPath)
    {
    	...
    	for(String seg : segs)
    	{
    		if(first)
    			...
    			strBld.append('/') ;
    		strBld.append(encode(seg , PATHSAFE , false)) ; 
    	}
    	return strBld.toString() ;
    }
	...
	{
		return new DataOutputStream(aOuts) ;
	}
	
	public static URLCoder getDefault()
	{
		if(sDefault == null)
			sDefault = new URLCoder(true) ;
	 ...
	 * @return
	 */
	public static URLCoder getInstance_1()
	{
		if(sInstance_1 == null)
			sInstance_1 = new URLCoder(false) ;
