...
public class PgConstraintSchema extends ConstraintSchema
{
	...
	public PgConstraintSchema()
	{
		super() ;
	}
	
	public PgConstraintSchema(String aName)
	{
		super(aName) ;
	}
	...
	{
		PgConstraintSchema clone = new PgConstraintSchema() ;
		initClone(clone) ;
		return clone ;
	}
	
	public static PgConstraintSchema createPrimary()
	{
		return new PgConstraintSchema(sV_PRIMARY) ;
	}
